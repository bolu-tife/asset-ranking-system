...
/**
 * This object represents the pricing data for a single stock on a particular
 * day.
 * 
 * @author richardm
 *
...
public class StockPrice implements Serializable {
	...
	/**
	 * Builds a StockPrice instance based on a Spark SQL row, which is what is read
	 * from the input file. The input file is in CSV format, where each row
	 * contains: Date,Open,High,Low,Close,Adj Close,Volume,Stock
	 */
